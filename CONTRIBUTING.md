...
After a change is merged to the `main`, please ask a Splunk maintainer to release the layer or build and release it to your own AWS account.

New ARNs will be published in [the layers repository](https://github.com/signalfx/lambda-layer-versions)