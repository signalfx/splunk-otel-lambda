...
cd "$SOURCES_DIR"
sed -i 's/^opentelemetry-distro.*/splunk-opentelemetry[all]==1.17.0/g' requirements.txt
sed -i 's/^opentelemetry-exporter-otlp-proto-http.*/opentelemetry-exporter-otlp-proto-http==1.22.0/g' requirements.txt
# Even if this regex does nothing, leave these lines in to make later updates easier
sed -i 's/0.43b0/0.43b0/g' requirements-nodeps.txt
sed -i 's/0.43b0/0.43b0/g' requirements.txt
