...
sed -i 's/^opentelemetry-exporter-otlp-proto-http.*/opentelemetry-exporter-otlp-proto-http==1.13.0/g' requirements.txt
sed -i 's/0.34b0/0.33b0/g' requirements-nodeps.txt
sed -i 's/0.34b0/0.33b0/g' requirements.txt
